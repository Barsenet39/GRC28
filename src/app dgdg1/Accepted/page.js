...
import { FaFileAlt, FaDownload, FaCalendarAlt, FaProjectDiagram, FaEye, FaBuilding, FaMapMarkerAlt, FaPhone, FaEnvelope, FaCheckCircle } from 'react-icons/fa'; // Importing icons
...
const View = () => {
  ...
  // Approval detail for Deputy Director Approval
  ...
  const documentList = [
    { id: 1, name: "Letter to BAYDO.corporation.pdf" },
    { id: 2, name: "Letter to BAYDO.corporation.pdf" },
  ];
      ...
      <div className="container mx-auto flex gap-4 w-full">
        ...
        <div className="w-1/2 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            {/* Project 1 */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700">Project 1</h3>
              <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                <div className="flex items-center">
                  <FaFileAlt className="text-gray-500 mr-2" />
                  <span>Letter to BAYDO.corporation.pdf</span>
            ...
            {/* Project 2 */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700">Project 2</h3>
              <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                <div className="flex items-center">
                  <FaFileAlt className="text-gray-500 mr-2" />
                  <span>Letter to BAYDO.corporation.pdf</span>
