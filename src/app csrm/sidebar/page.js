        ...
        <div>
          ...
          <ul>
            ...
            <li className="mb-4 flex items-center">
              ...
              <a href="/request-response" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Requests Response</a>
            </li>
            <li className="mb-4 flex items-center">
              <DocumentTextIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-indigo-600'}`} />
            ...
            <li className="mb-4 flex items-center justify-between cursor-pointer">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className={`text-sm ${isOpen ? 'block' : 'hidden'}`}>CSRM Expert</div>
                </div>
              </div>
              {isOpen && (
