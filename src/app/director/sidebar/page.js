        ...
        <div>
          ...
          <ul>
            <li className="mb-4 flex items-center">
              ...
              <a href="../director/dashboard" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Dashboard</a>
            </li>
            <li className="mb-4 flex items-center">
              <PlusIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-green-500'}`} />
              <a href="../director/new-request" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>New Request</a>
            ...
            <li className="mb-4 flex items-center">
              ...
              <a href="../director/request-status" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Requests Status</a>
            </li>
            <li className="mb-4 flex items-center">
              <DocumentTextIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-indigo-600'}`} />
              <a href="../director/returned-requests" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Returned Requests</a>
            </li>
          </ul>
        </div>
        <div className="mt-6">
            ...
            <li className="mb-4 flex items-center justify-between cursor-pointer">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className={`text-sm ${isOpen ? 'block' : 'hidden'}`}>Directorate Director</div>
                </div>
              </div>
              {isOpen && (
