...
const View = () => {
  ...
  <div className="flex justify-between mb-2">
    ...
    <span className={`w-2/3 text-left ${requestDetails.status === 'Closed' ? 'text-blue-600' : ''}`}>
      {requestDetails.status}
          ...
          <h2 className="text-lg font-semibold mt-6 text-black">Closure Letter</h2>
          <div className="flex items-center justify-between bg-gray-50 p-3 rounded-md mt-2">
            <span className="text-black">Closure Letter.pdf</span>
            <div className="flex items-center">
              <FaEye 
                className="text-blue-600 cursor-pointer mr-2" 
                onClick={() => handleView("Closure_Letter.pdf")} 
              />
              <FaDownload 
                className="text-blue-600 cursor-pointer" 
                onClick={() => handleDownload("Closure_Letter.pdf")} 
              />
            </div>
          </div>
        </div>
      ...
      <div className="bg-white shadow-md p-6 rounded-lg w-full max-w-6xl mt-6">
        ...
        <p className="mb-4 text-gray-600">This is the complete Worsks</p>
        ...
        <div className="border border-gray-300 rounded-md mb-4 p-4">
          <h3 className="font-semibold text-black">Project 3</h3>
          ...
          {isSubmitted && <p className="text-green-600 mt-2">Submitted</p>}
        </div>
      </div>
    </div>
  );
