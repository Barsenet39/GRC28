...
const View = () => {
  ...
  const riskCards = [
    ...
    },
    {
      ...
      description:
        "Assesses tactical execution risks. Cost: up to 1,700,000 ETB.",
      image: "/1.png",
    },
    {
      id: 2,
      ...
      description:
        "Targets daily risks. Cost: up to 1,900,000 ETB.",
      image: "/2.png",
    },
    {
      id: 3,
      ...
      description:
        "Analyzes awareness and attitudes. Cost: up to 1,500,000 ETB.",
      image: "/3.png",
    },
    {
      id: 4,
      ...
      description:
        "Ensures asset tracking and profiling. Cost: up to 1,300,000 ETB.",
      image: "/4.png",
    },
    {
      id: 5,
      ...
      description:
        "Examines vulnerabilities. Cost: up to 1,800,000 ETB.",
      image: "/5.png",
    },
    {
      id: 6,
      ...
      description:
        "Supports continuity and compliance. Cost: up to 800,000 ETB.",
      image: "/6.png",
    },
    {
      id: 7,
      ...
      title:
        "Roles and Responsibilities for Management, Risk Communication and Mitigation Document",
      description:
        "Defines governance roles. Cost: up to 500,000 ETB.",
      image: "/7.png",
    },
    {
      id: 8,
      ...
      description:
        "Quantifies risks. Cost: up to 1,200,000 ETB.",
      image: "/8.png",
    },
    {
      id: 9,
      ...
      description:
        "Outlines goals. Cost: up to 2,200,000 ETB.",
      image: "/9.png",
    },
    {
      id: 10,
      ...
      description:
        "Establishes governance framework. Cost: up to 1,500,000 ETB.",
      image: "/10.png",
    },
    {
      id: 11,
      ...
      description:
        "Timeline for initiatives. Cost: up to 2,200,000 ETB.",
      image: "/11.png",
    },
    {
      id: 12,
      ...
      description:
        "Defines principles. Cost: up to 2,000,000 ETB.",
      image: "/12.png",
    },
    {
      id: 13,
      ...
      description:
        "Ensures consistency. Cost: up to 2,600,000 ETB.",
      image: "/13.png",
    },
    {
      id: 14,
      ...
      description:
        "Details initiatives. Cost: up to 2,200,000 ETB.",
      image: "/14.png",
    },
    {
      id: 15,
      ...
      description:
        "Covers specific threats. Cost: up to 2,100,000 ETB.",
      image: "/15.png",
    },
    {
      id: 16,
      ...
      description:
        "Tailored policies. Cost: up to 1,200,000 ETB.",
      image: "/16.png",
    },
    {
      id: 17,
      ...
      description:
        "Documents procedures. Cost: up to 2,000,000 ETB.",
      image: "/17.png",
    },
  ];
...
const handleSubmit = () => {
  ...
  // Group by headings
  const grouped = {};
  selectedData.forEach(({ mainTitle, category, subCategory, item, id }) => {
  ...
  // Save selected services for later view
  localStorage.setItem("selectedServices", JSON.stringify(services));

  // Read file and store request
  ...
  reader.onloadend = () => {
    ...
    const newRequest = {
      ...
      status: "Requested",
      services,
      files: { [uploadedFile.name]: fileBase64 },
    };

    const existing = JSON.parse(localStorage.getItem("requests") || "[]");
    const updated = [...existing, newRequest].slice(-20);
    localStorage.setItem("requests", JSON.stringify(updated));

    alert("Form submitted!");
    router.push("/Requests?id=" + encodeURIComponent(newRequest.id));
  };
...
{/* Section: Cyber Security Management */}
<h1 className="text-3xl font-bold mt-10 mb-2 text-center text-gray-800">
  Cyber Security Management
</h1>

{["Governance Document Development"].map((section) => (
  <div key={section} className="w-full">
    <h2 className="text-xl font-bold mt-4 mb-4 text-center text-gray-800 border-b pb-2">
      {section}
    </h2>
