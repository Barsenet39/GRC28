...
const View = () => {
  ...
  <div className="flex justify-between mb-2">
    ...
    <div className="flex justify-between mb-2">
      ...
      <span className={`w-2/3 text-left ${requestDetails.status === 'Expired' ? 'text-blue-600' : ''}`}>
        {requestDetails.status}
          ...
          <div className="flex items-center justify-between bg-gray-50 p-3 rounded-md mt-2">
            ...
            <div className="flex items-center">
              <FaEye 
                className="text-blue-600 cursor-pointer mr-2" 
                onClick={() => handleView("Letter to BAYDD.corportion.pdf.pdf")} 
              />
              <FaDownload 
                className="text-blue-600 cursor-pointer" 
                onClick={() => handleDownload("Letter to BAYDD.corportion.pdf.pdf")} 
              />
            </div>
          </div>
        </div>
