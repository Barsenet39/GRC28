        ...
        <div className="w-1/2 pl-4">
          ...
          <div className="bg-red-100 rounded-lg p-4 mb-6">
            <div className="bg-white rounded-lg p-4 flex items-start">
              <svg className="w-5 h-5 text-gray-500 mr-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z" />
              </svg>
              <div>
                <div className="font-semibold text-gray-700 mb-1">Rejected Reason</div>
                <div className="text-gray-700 text-sm">
                  Please review your work carefully and make the necessary corrections. There are several errors that need to be
                </div>
              </div>
            </div>
          </div>
...
// Add this for the rejected reason
const rejectedReason = "Please review your work carefully and make the necessary corrections. There are several errors that need to be fixed.";
