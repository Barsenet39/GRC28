        ...
        <div>
          ...
          <ul>
            <li className="mb-4 flex items-center">
              ...
              <a href="../Deputy_Director/dashboard" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Dashboard</a>
            </li>
            <li className="mb-4 flex items-center">
              <PlusIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-green-500'}`} />
              <a href="../Deputy_Director/new-request" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>New Request</a>
            ...
            <li className="mb-4 flex items-center">
              ...
              <a href="../Deputy_Director/request-status" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Requests Status</a>
            </li>
          </ul>
        </div>
        <div className="mt-6">
            ...
            <li className="mb-4 flex items-center justify-between cursor-pointer">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className={`text-sm ${isOpen ? 'block' : 'hidden'}`}>Deputy Director</div>
                </div>
              </div>
              {isOpen && (
