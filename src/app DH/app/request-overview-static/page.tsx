...
export default function RequestOverviewStaticPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
            ...
            <div>
              ...
              <div className="ml-6 space-y-2 text-gray-800">
                <p className="flex items-center">
                  ...
                  <span className="ml-auto">600,000-1,500,00</span>
                </p>
                <p className="flex items-center">
                  <span className="w-3 h-3 rounded-full bg-blue-500 mr-2"></span>
                  Tactical Level Risk Assessment
                  <span className="ml-auto">680,000-1,700,00</span>
                </p>
              </div>
            </div>
            <div>
        ...
        {/* Request Documents and Approval Status */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-purple-50 p-4 rounded-lg shadow">
          ...
          <div className="bg-purple-50 p-4 rounded-lg shadow">
            ...
            <div className="space-y-2">
              <div className="flex items-center">
                ...
                <p className="font-semibold text-gray-800">Directorate Director Comment</p>
              ...
              <div className="flex items-center">
                ...
                <p className="font-semibold text-gray-800">Division Head Comment</p>
                <span className="ml-auto text-gray-800"></span>
              </div>
            </div>
          </div>
        ...
        {/* Service Agreement and Comment Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-purple-50 p-4 rounded-lg shadow">
          ...
          <div className="bg-purple-50 p-4 rounded-lg shadow">
            <h2 className="text-lg font-semibold mb-4 text-gray-800">If you have any comments, please write them below.</h2>
            <textarea
            color="black"
              value={comment}
