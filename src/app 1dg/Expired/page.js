...
import { FaFileAlt, FaEye, FaDownload, FaTools } from 'react-icons/fa'; // Importing icons
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      <div className="container mx-auto bg-white rounded-lg shadow-md p-6 flex gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow mb-6">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>
                ...
                <span className="ml-2 px-2 py-1 bg-red-100 text-red-800 rounded-full text-sm">Expired</span>
              </p>
            </div>
          </div>
        ...
        <div className="w-1/2 pl-4 flex flex-col gap-4">
          ...
          {/* Document Section */}
          <div className="bg-white rounded-lg p-4 shadow">
            <h2 className="text-lg font-semibold mb-3 text-gray-800">Document</h2>
            <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center">
                <FaFileAlt className="text-gray-500 mr-2" />
                <span>Organizational Cyber Management Policy.pdf</span>
