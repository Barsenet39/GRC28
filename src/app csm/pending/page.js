...
import { FaFileAlt, FaEye, FaDownload, FaCalendarAlt, FaProjectDiagram, FaBuilding, FaInfoCircle, FaPhone, FaEnvelope, FaTools, FaCheckCircle } from 'react-icons/fa'; // Importing icons
...
const View = () => {
  ...
  const companyInfo = {
    ...
    address: "123 Meskel Adebaby, Addis Ababa",
  ...
  const requestServices = [
    ...
    },
    {
      ...
      services: [
        { name: "Governance Document Development", cost: "UP TO 1,500,00" },
  ...
  const requestDocuments = [
    { name: "Organizational Cyber Management Policy.pdf" },
  ];

  const approvalStatus = [
    { role: "Directorate Director Approval", status: "pending", comment: "Pending review of security assessment details" },
    { role: "Division Head Approval", status: "pending", comment: "Awaiting initial approval from Directorate Director" },
  ];
      ...
      <div className="container mx-auto bg-white rounded-lg shadow-md p-4 flex gap-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="flex items-center">
                ...
                <span className="ml-2 px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs">{requestDetails.status}</span>
              </p>
            </div>
          </div>
        ...
        <div className="w-1/2">
          ...
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            {requestDocuments.map((document, idx) => (
          ...
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg text-sm">
              <div className="flex items-center">
                <FaFileAlt className="text-gray-500 mr-2" />
                <span>Letter to BAYDD.corportion.pdf</span>
              </div>
              <div className="flex space-x-2">
                <button
                  className="p-2 hover:bg-gray-200 rounded-full"
                  onClick={() => handleDownload("Letter_to_BAYDD.corportion.pdf")}
                  aria-label="Download"
                >
                  <FaDownload className="text-blue-600" />
                </button>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-4 max-w-2xl w-full mx-4">
              <div className="flex justify-between items-center mb-3">
                <h3 className="text-lg font-semibold">{selectedRole || selectedDocument?.name}</h3>
              ...
              <div className="mb-3">
                ...
                {selectedDocument && (
                  <p>Document Preview Placeholder</p> // Replace with actual document preview
                )}
              </div>
