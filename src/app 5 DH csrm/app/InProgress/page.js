...
import { FaFileAlt, FaEye, FaDownload, FaCalendarAlt } from 'react-icons/fa'; // Importing icons
      ...
      <div className="container mx-auto bg-white rounded-lg shadow-md p-6 flex gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow mb-6">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="flex items-center gap-1">
                  <span className="inline-block bg-pink-100 text-pink-600 px-2 py-0.5 rounded-full text-xs font-semibold mr-1">
                    Project
                  </span>
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className="inline-block bg-blue-100 text-blue-600 px-2 py-0.5 rounded-full text-xs font-semibold">
                  In progress
                </span>
              </div>
              {/* Assigned Date */}
        ...
        <div className="w-1/2 pl-4 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg p-4 shadow mb-2">
            <h2 className="text-lg font-semibold mb-3 text-gray-800">Assigned Experts</h2>
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 bg-gray-50 rounded-lg p-3 flex flex-col items-start">
                <span className="font-semibold text-gray-700">Bereket Adisu</span>
                <span className="text-xs text-gray-500 mb-1">20002548</span>
                <span className="text-xs text-green-600 font-medium">Expertise: TM</span>
              </div>
              <div className="flex-1 bg-gray-50 rounded-lg p-3 flex flex-col items-start">
                <span className="font-semibold text-gray-700">Birhanu Aleka</span>
                <span className="text-xs text-gray-500 mb-1">20002552</span>
                <span className="text-xs text-green-600 font-medium">Expertise: PM</span>
              </div>
            </div>
          </div>
