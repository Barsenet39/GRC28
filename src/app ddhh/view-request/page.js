...
<div className="bg-white p-6 rounded-lg shadow-md mb-6">
  ...
  <h2 className="text-xl font-semibold mb-6 text-gray-700">Request Service</h2> {/* Increased margin-bottom for header */}

  <div className="flex justify-between pb-12"> {/* Increased padding-bottom */}
    {/* First Service */}
    <div className="w-1/2">
      <div className="flex items-center mb-5"> {/* Increased margin-bottom */}
      ...
      <ul className="list-disc pl-6">
        <li className="text-gray-600 mb-4 flex">
          <strong className="text-gray-800 flex-shrink-0">Strategic Level Risk Assessment:</strong> {/* Ensured no shrinking */}
          <span className="text-gray-800 ml-4">Up to 1,500.00</span>
        </li>
        <li className="text-gray-600 mb-4 flex">
          <strong className="text-gray-800 flex-shrink-0">Tactical Level Risk Assessment:</strong> {/* Ensured no shrinking */}
    ...
    <div className="w-1/2">
      <div className="flex items-center mb-5"> {/* Increased margin-bottom */}
        ...
        <span className="font-medium text-gray-600 ml-3">Cyber Security Management Service</span>
      </div>
      <ul className="list-disc pl-6">
        <li className="text-gray-600 mb-4 flex">
          <strong className="text-gray-800 flex-shrink-0">Governance Document Development:</strong> {/* Ensured no shrinking */}
          <span className="text-gray-800 ml-16">Up to 1,500.00</span>
        </li>
        <li className="text-gray-600 mb-4 flex">
          <strong className="text-gray-800 flex-shrink-0">Roles and Responsibilities for Management:</strong> {/* Ensured no shrinking */}
 ...
 <div className="flex gap-6 mt-6">
  {/* Left Column: Request Letter + Approval Status */}
  <div className="w-full max-w-lg">
    ...
    <div className="bg-white p-4 rounded-2xl shadow-2xl mt-4">
      <h3 className="text-center font-bold text-lg sm:text-xl md:text-2xl text-black mb-8">
        Approval Status
      </h3>
  ...
  {/* Right Column: Assign to Technical Manager */}
  <div className="w-full max-w-md">
    <div className="bg-white shadow-md rounded-xl p-6">
      <h2 className="text-lg font-semibold mb-2">Assign to Technical Manager</h2>
      <p className="text-sm text-gray-600 mb-4">
        Assign a technical manager who is suitable for this project to review its technical aspects.
      </p>
      <button
        className="bg-green-500 text-white py-2 px-4 rounded-md text-sm hover:bg-blue-500 transition-colors duration-200"
        onClick={() => handleAssign('YOUR_STATIC_REQUEST_ID')}
      >
        Assign
      </button>
    </div>
