...
const View = () => {
  ...
  const getIconColor = (type) => {
    if (type === 'Project') {
      return 'text-orange-400'; // Use a softer orange
    } else {
      return 'text-green-400'; // Use a softer green
    }
  };
            ...
            <tbody className="text-gray-600 text-sm font-light">
              {requests.map((request, index) => (
                ...
                >
                  ...
                  {/* Use font-medium for company name */}
                  ...
                  <td className="py-3 px-6 text-left">
                    <div className="flex items-center">
                      {request.type ? (
                        ...
                        <>
                          <FaTools className={`inline-block mr-1 ${getIconColor(request.types)}`} />
                  ...
                  <td className="py-3 px-6 text-center">
                    <button
                      ...
                      /* Use rounded-md for a softer button */
