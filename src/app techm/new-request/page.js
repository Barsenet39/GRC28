...
const View = () => {
  ...
  const initialRequests = [
    ...
    { id: 'REG/978365', companyName: 'Another University', date: '2020-12-15', type: 'Technical Support' },
    { id: 'REG/978366', companyName: 'Tech University', date: '2021-01-20', type: 'Project' },
    { id: 'REG/978367', companyName: 'Global Institute of Technology', date: '2021-02-25', type: 'Technical Support' },
    { id: 'REG/978368', companyName: 'City College', date: '2021-03-10', type: 'Project' },
    { id: 'REG/978369', companyName: 'National University', date: '2021-04-15', type: 'Technical Support' },
    { id: 'REG/978370', companyName: 'Innovation Academy', date: '2021-05-05', type: 'Project' },
    { id: 'REG/978371', companyName: 'Future Tech University', date: '2021-06-18', type: 'Technical Support' },
    { id: 'REG/978372', companyName: 'E-Learning Institute', date: '2021-07-22', type: 'Project' },
    { id: 'REG/978373', companyName: 'Digital College', date: '2021-08-30', type: 'Technical Support' },
  ];
          ...
          <table className="min-w-full bg-white rounded-lg overflow-hidden">
            ...
            <tbody className="text-gray-600 text-sm font-light">
              {requests.map((request, index) => (
                <tr key={request.id} className={`border-b border-gray-200 hover:bg-gray-100 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
