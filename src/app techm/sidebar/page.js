      ...
      <div className="flex flex-col justify-between h-full pb-4">
        <div>
          ...
          <ul>
            ...
            {/* New "Returned Requests" section */}
            <li className="mb-4 flex items-center">
              <RefreshIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-red-500'}`} />
            ...
            <li className="mb-4 flex items-center justify-between cursor-pointer">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className={`text-sm ${isOpen ? 'block' : 'hidden'}`}>Technical Manager</div>
                </div>
              </div>
              {isOpen && (
