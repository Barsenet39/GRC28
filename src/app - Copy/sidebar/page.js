        ...
        <div>
          ...
          <ul>
            ...
            <li className="mb-4 flex items-center">
              ...
              <a href="/requests-response" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Requests Response</a>
            </li>
            <li className="mb-4 flex items-center">
              <RefreshIcon className={`w-6 h-6 mr-2 ${isDarkMode ? 'text-white' : 'text-yellow-500'}`} />
              <a href="/returned-requests" className={`text-lg hover:text-gray-600 ${isOpen ? 'block' : 'hidden'}`}>Returned Requests</a>
            </li>
          </ul>
        </div>
        <div className="mt-6">
